...
public class GlobalExceptionHandler {
    ...
    public ResultVO handleRuntimeException(RuntimeException e){
        e.printStackTrace();
        return new ResultVO(7000,"您的操作有误",false,e.getMessage());
    }
